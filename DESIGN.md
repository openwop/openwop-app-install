...
11. **Grid + List is ONE toggle, not a per-page reinvention** (the *collection-view
    ...
    Documents, Advisors, Strategy, Priority-matrix) offers the SAME two views via
    ...
    **Card** (grid cell) + **Row** (list cell), and — per rule 6 — derives both
    ...
    nav-rails (CMS, Email, Forms, Publishing, Sharing) are out of scope.
