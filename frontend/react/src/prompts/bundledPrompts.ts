...
export const BUNDLED_PROMPTS: PromptTemplate[] = [
  {
  ...
  },
  {
    ...
    description:
      'Teaches the LLM to wrap structured intents in the OpenWOP envelope shape so the host can route them deterministically. Free-form prose stays prose.',
    text: [
      ...
      '',
      'Reference: see spec/v1/ai-envelope.md for the canonical wire shape.',
    ].join('\n'),
